...
var __PRIVATE_WatchChangeAggregator = class {
  ...
  tt(e) {
    this.forEachTarget(e, (t) => {
      ...
      if (n)
        ...
        __PRIVATE_logDebug(mt, `handleTargetChange received targetChange for untracked target ID (${t}) with state (${e.state})`);
    });
  }
  /**
  ...
  Ye(e, t) {
    ...
    if (!n || !this.nt(e))
      return void __PRIVATE_logDebug(mt, `addDocumentToTarget received document for unknown inactive target (${e})`);
...
function toMutation(e, t) {
  ...
  return t.fieldTransforms.length > 0 && (n.updateTransforms = t.fieldTransforms.map((e2) => function __PRIVATE_toFieldTransform(e3, t2) {
    ...
    if (n2 instanceof __PRIVATE_NumericMinimumTransformOperation)
      return {
        fieldPath: t2.field.canonicalString(),
        minimum: n2.Ae
      };
    if (n2 instanceof __PRIVATE_NumericMaximumTransformOperation)
      return {
        fieldPath: t2.field.canonicalString(),
        maximum: n2.Ae
      };
...
function __PRIVATE_fromMutation(e, t) {
  const n = t.currentDocument ? function __PRIVATE_fromPrecondition(e2) {
    ...
    if ("setToServerValue" in t3)
      ...
      "increment" in t3 ? n2 = new __PRIVATE_NumericIncrementTransformOperation(e2, t3.increment) : "minimum" in t3 ? n2 = new __PRIVATE_NumericMinimumTransformOperation(e2, t3.minimum) : "maximum" in t3 ? n2 = new __PRIVATE_NumericMaximumTransformOperation(e2, t3.maximum) : fail(16584, {
        proto: t3
      });
...
var __PRIVATE_FirestoreIndexValueWriter = class {
  ...
  Dt(e, t) {
    if ("nullValue" in e)
      ...
      this.vt(t, 10), t.Ft(e.booleanValue ? 1 : 0);
    else if ("integerValue" in e)
      this.vt(t, 15), t.Ft(__PRIVATE_normalizeNumber(e.integerValue));
      ...
      this.vt(t, 30), t.Nt(__PRIVATE_normalizeByteString(e.bytesValue)), this.Ot(t);
      ...
      "mapValue" in e ? __PRIVATE_isMaxValue(e) ? this.vt(t, Number.MAX_SAFE_INTEGER) : __PRIVATE_isVectorValue(e) ? this.Lt(e.mapValue, t) : (this.kt(e.mapValue, t), this.Ot(t)) : "arrayValue" in e ? (this.qt(e.arrayValue, t), this.Ot(t)) : fail(19022, {
        Kt: e
      });
  }
  xt(e, t) {
  ...
  Ht(e) {
    for (const t of e) {
      ...
      if (e2 < 128)
        ...
        this.Qt(960 | e2 >>> 6), this.Qt(128 | 63 & e2);
      else if (t < "\uD800" || "\uDBFF" < t)
        this.Qt(480 | e2 >>> 12), this.Qt(128 | 63 & e2 >>> 6), this.Qt(128 | 63 & e2);
      else {
  ...
  fn(e) {
    ...
    if (this.An.size > 0) {
      ...
      if (!r.has(e2.field.canonicalString())) {
        const t2 = n[i];
        if (!this.pn(e2, t2) || !this.yn(this.Vn[s++], t2))
          return false;
      }
      ++i;
    }
    for (; i < n.length; ++i) {
      const e2 = n[i];
      if (s >= this.Vn.length || !this.yn(this.Vn[s++], e2))
        return false;
    }
    return true;
  }
    ...
    if (null != i) {
      ...
      if (isArray(s))
        for (const i2 of s.arrayValue.values || [])
          n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.On(i2), r));
    } else
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 18) {
    ...
    this.Li = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.v())
  ...
  async Yi() {
    if (this.isPrimary && !this.es(this.Bi, Mt)) {
      ...
      if (this.Ki)
        for (const t of e)
          this.Ki.removeItem(this.ns(t.clientId));
    }
  }
  /**
  ...
  ji(e) {
    ...
    return __PRIVATE_primaryClientStore(e).get(Q).next((t) => {
      if (null !== t && this.es(t.leaseTimestampMs, xt) && !this.rs(t.ownerId)) {
        if (this.Zi(t) && this.networkEnabled)
          return true;
        if (!this.Zi(t)) {
  ...
  runTransaction(e, t, n) {
    ...
    return this.qi.runTransaction(e, r, i, (r2) => (s = new __PRIVATE_IndexedDbTransaction(r2, this._i ? this._i.next() : __PRIVATE_ListenSequence.ce), "readwrite-primary" === t ? this.zi(s).next((e2) => !!e2 || this.ji(s)).next((t2) => {
      if (!t2)
        throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.Di.enqueueRetryable(() => this.Li(false)), new FirestoreError(D.FAILED_PRECONDITION, B);
      return n(s);
  ...
  hs(e) {
    return __PRIVATE_primaryClientStore(e).get(Q).next((e2) => {
      if (null !== e2 && this.es(e2.leaseTimestampMs, xt) && !this.rs(e2.ownerId) && !this.Zi(e2) && !(this.Fi || this.allowTabSynchronization && e2.allowTabSynchronization))
        throw new FirestoreError(D.FAILED_PRECONDITION, Ot);
    });
  }
  /**
...
var __PRIVATE_QueryEngine = class {
  ...
  getDocumentsMatchingQuery(e, t, n, r) {
    ...
    return this.fs(e, t).next((e2) => {
      ...
      if (!i.result)
        return this.gs(e, t, r, n).next((e2) => {
          i.result = e2;
        });
    }).next(() => {
      if (i.result)
...
function __PRIVATE_localStoreExecuteQuery(e, t, n) {
  ...
  return r.persistence.runTransaction(
    ...
    (e2) => function __PRIVATE_localStoreGetTargetData(e3, t2, n2) {
      ...
      if (t2)
        return i = t2.lastLimboFreeSnapshotVersion, r.ci.getMatchingKeysForTargetId(e2, t2.targetId).next((e3) => {
          s = e3;
        });
...
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (e2) => {
    ...
    if (r.snapshotVersion.compareTo(s) >= 0)
      return i.hi.saveNamedQuery(e2, t);
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  js(e) {
    ...
    if (t.storageArea === this.storage) {
      if (__PRIVATE_logDebug(Ut, "EVENT", t.key, t.newValue), t.key === this.Zs)
    ...
    return __PRIVATE_unguardedEventListen(u, WebChannel.EventType.OPEN, () => {
      ...
      if (!l) {
        ...
        if (s2) {
          ...
          __PRIVATE_logDebug(zt, `RPC '${e}' stream ${r} received:`, n2), h.o_(n2);
      }
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  ...
  else if (t instanceof __PRIVATE_DocumentWatchChange ? e.ga.Xe(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.ga.it(t) : e.ga.tt(t), !n.isEqual(SnapshotVersion.min()))
    try {
...
var __PRIVATE_BundleLoader = class {
  ...
  Ja(e) {
    ...
    if (e.Wa.namedQuery)
      ...
      e.Wa.document && (this.ja[this.ja.length - 1].document = e.Wa.document, ++t);
...
async function __PRIVATE_syncEngineUnlisten(e, t, n) {
  ...
  if (s.length > 1)
    return r.Au.set(i.targetId, s.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void r.Ru.delete(t);
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  for (const r of e.Au.get(t))
    e.Ru.delete(r), n && e.Eu.bu(r, n);
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r of n)
    if (r instanceof __PRIVATE_AddedLimboDocument)
      e.fu.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
  ...
  mc() {
    if (this.path)
      for (let e = 0; e < this.path.length; e++)
        this.yc(this.path.get(e));
  }
  yc(e) {
    if (0 === e.length)
      throw this.bc("Document fields must not be empty");
    if (__PRIVATE_isWrite(this.dataSource) && _n.test(e))
      throw this.bc('Document fields cannot begin and end with "__"');
  }
};
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.dataSource)
      throw 1 === e.dataSource ? e.bc(`${this._methodName}() can only appear at the top level of your update data`) : e.bc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.dataSource))
        throw t2.bc(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path)
        throw t2.bc(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  if (
    ...
    if (t.settings.arrayElement && 4 !== t.dataSource)
      throw t.bc("Nested arrays are not supported");
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r.isEqual(n))
        throw t2.bc(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
      return {
          ...
          fields: {
            ...
            [ut]: {
              arrayValue: {
                values: n.map((e4) => {
                  if ("number" != typeof e4)
                    throw t3.bc("VectorValues must only contain numeric values.");
